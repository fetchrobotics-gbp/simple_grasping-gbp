## simple_grasping (melodic) - 0.4.1-1

The packages in the `simple_grasping` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic -t melodic simple_grasping` on `Tue, 13 Jun 2023 13:43:31 -0000`
...
## simple_grasping (noetic) - 0.4.1-1

The packages in the `simple_grasping` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic -t noetic simple_grasping` on `Mon, 24 Apr 2023 14:20:22 -0000`
...
## simple_grasping (lunar) - 0.3.1-0

The packages in the `simple_grasping` repository were released into the `lunar` distro by running `/usr/bin/bloom-release -r lunar -t lunar simple_grasping` on `Wed, 15 Aug 2018 00:50:19 -0000`
...
## simple_grasping (melodic) - 0.2.2-0
